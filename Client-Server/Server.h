			...
			for (auto& p : fs::directory_iterator(fs::current_path())) {
				if (p.path().extension().string() == ".in") {
					...
					if (prev != temp[0])	{
						...
						this->dataGridView3->Rows[i]->Cells[1]->Value = gcnew System::String(temp[0].c_str());
						this->dataGridView3->Rows[i]->Cells[2]->Value = gcnew System::String(asctime(std::localtime(&cftime)));
					}
					i++;
				}
			}
...
private: System::Windows::Forms::DataGridViewButtonColumn^ loadCol;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->loadCol = (gcnew System::Windows::Forms::DataGridViewButtonColumn());
			...
			this->print_button->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->print_button->Location = System::Drawing::Point(1113, 454);
			this->print_button->Margin = System::Windows::Forms::Padding(2);
			this->print_button->Name = L"print_button";
			this->print_button->Size = System::Drawing::Size(58, 24);
			...
			this->dataGridView3->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(3) {
				this->loadCol,
					this->filesCol, this->dateCol
			});
			this->dataGridView3->Location = System::Drawing::Point(9, 122);
			this->dataGridView3->Margin = System::Windows::Forms::Padding(2);
			this->dataGridView3->Name = L"dataGridView3";
			this->dataGridView3->RowHeadersWidth = 51;
			this->dataGridView3->RowTemplate->Height = 24;
			this->dataGridView3->Size = System::Drawing::Size(372, 327);
			...
			this->close_button->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->close_button->Location = System::Drawing::Point(9, 461);
			this->close_button->Margin = System::Windows::Forms::Padding(2);
			this->close_button->Name = L"close_button";
			this->close_button->Size = System::Drawing::Size(58, 24);
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label5->Location = System::Drawing::Point(14, 21);
			...
			this->h_name->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->h_name->Location = System::Drawing::Point(71, 22);
			this->h_name->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->h_name->Name = L"h_name";
			this->h_name->Size = System::Drawing::Size(15, 19);
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label7->Location = System::Drawing::Point(14, 40);
			...
			this->ip_text->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->ip_text->Location = System::Drawing::Point(98, 42);
			this->ip_text->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->ip_text->Name = L"ip_text";
			this->ip_text->Size = System::Drawing::Size(14, 20);
			...
			this->Client_tab->Location = System::Drawing::Point(386, 89);
			this->Client_tab->Margin = System::Windows::Forms::Padding(2);
			this->Client_tab->Name = L"Client_tab";
			this->Client_tab->SelectedIndex = 0;
			this->Client_tab->Size = System::Drawing::Size(788, 360);
			...
			this->tabPage2->Size = System::Drawing::Size(780, 334);
			...
			this->groupBox1->Size = System::Drawing::Size(288, 158);
			...
			this->product_name->Location = System::Drawing::Point(95, 126);
			this->product_name->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->product_name->Name = L"product_name";
			this->product_name->Size = System::Drawing::Size(11, 15);
			...
			this->label1->Location = System::Drawing::Point(7, 126);
			...
			this->sys_name->Location = System::Drawing::Point(94, 104);
			this->sys_name->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->sys_name->Name = L"sys_name";
			this->sys_name->Size = System::Drawing::Size(11, 15);
			...
			this->build_number->Location = System::Drawing::Point(91, 82);
			this->build_number->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->build_number->Name = L"build_number";
			this->build_number->Size = System::Drawing::Size(11, 15);
			...
			this->os_version->Location = System::Drawing::Point(81, 59);
			this->os_version->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->os_version->Name = L"os_version";
			this->os_version->Size = System::Drawing::Size(11, 15);
			...
			this->ip_address->Location = System::Drawing::Point(77, 37);
			this->ip_address->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->ip_address->Name = L"ip_address";
			this->ip_address->Size = System::Drawing::Size(11, 15);
			...
			this->label6->Location = System::Drawing::Point(8, 37);
			...
			this->dataGridView2->Location = System::Drawing::Point(318, 12);
			this->dataGridView2->Margin = System::Windows::Forms::Padding(2);
			this->dataGridView2->Name = L"dataGridView2";
			this->dataGridView2->RowHeadersWidth = 51;
			this->dataGridView2->RowTemplate->Height = 24;
			this->dataGridView2->Size = System::Drawing::Size(457, 310);
			...
			this->tabPage3->Size = System::Drawing::Size(780, 334);
			...
			this->dataGridView4->Location = System::Drawing::Point(396, 17);
			this->dataGridView4->Margin = System::Windows::Forms::Padding(2);
			this->dataGridView4->Name = L"dataGridView4";
			this->dataGridView4->RowHeadersWidth = 51;
			this->dataGridView4->RowTemplate->Height = 24;
			this->dataGridView4->Size = System::Drawing::Size(371, 305);
			...
			this->dataGridView1->Location = System::Drawing::Point(13, 17);
			this->dataGridView1->Margin = System::Windows::Forms::Padding(2);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 51;
			this->dataGridView1->RowTemplate->Height = 24;
			this->dataGridView1->Size = System::Drawing::Size(371, 305);
			...
			this->live_usage->Location = System::Drawing::Point(4, 22);
			this->live_usage->Margin = System::Windows::Forms::Padding(2);
			this->live_usage->Name = L"live_usage";
			this->live_usage->Size = System::Drawing::Size(780, 334);
			...
			this->dataGridView5->Location = System::Drawing::Point(22, 20);
			this->dataGridView5->Margin = System::Windows::Forms::Padding(2);
			this->dataGridView5->Name = L"dataGridView5";
			this->dataGridView5->RowHeadersWidth = 51;
			this->dataGridView5->RowTemplate->Height = 24;
			this->dataGridView5->Size = System::Drawing::Size(739, 297);
			...
			this->allow_button->Location = System::Drawing::Point(82, 96);
			this->allow_button->Margin = System::Windows::Forms::Padding(2);
			this->allow_button->Name = L"allow_button";
			this->allow_button->Size = System::Drawing::Size(56, 21);
			...
			this->label9->Location = System::Drawing::Point(142, 100);
			...
			// seconds_text
			// 
			this->seconds_text->Location = System::Drawing::Point(172, 98);
			this->seconds_text->Margin = System::Windows::Forms::Padding(2);
			this->seconds_text->Name = L"seconds_text";
			this->seconds_text->Size = System::Drawing::Size(26, 20);
			...
			this->label10->Location = System::Drawing::Point(202, 100);
			...
			this->label11->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label11->Location = System::Drawing::Point(14, 58);
			...
			this->port_label->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->port_label->Location = System::Drawing::Point(52, 57);
			this->port_label->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->port_label->Name = L"port_label";
			this->port_label->Size = System::Drawing::Size(14, 20);
			...
			this->swapLabel->Location = System::Drawing::Point(739, 465);
			this->swapLabel->Name = L"swapLabel";
			this->swapLabel->Size = System::Drawing::Size(37, 13);
			...
			this->label12->Location = System::Drawing::Point(662, 465);
			...
			this->label13->Location = System::Drawing::Point(522, 465);
			...
			this->MemLabel->Location = System::Drawing::Point(609, 465);
			this->MemLabel->Name = L"MemLabel";
			this->MemLabel->Size = System::Drawing::Size(37, 13);
			...
			this->label14->Location = System::Drawing::Point(414, 465);
			...
			this->CpuLabel->Location = System::Drawing::Point(483, 465);
			this->CpuLabel->Name = L"CpuLabel";
			this->CpuLabel->Size = System::Drawing::Size(21, 13);
			this->CpuLabel->TabIndex = 19;
			this->CpuLabel->Text = L"0%";
			// 
			// loadCol
			// 
			this->loadCol->AutoSizeMode = System::Windows::Forms::DataGridViewAutoSizeColumnMode::ColumnHeader;
			this->loadCol->HeaderText = L"Load";
			this->loadCol->MinimumWidth = 40;
			this->loadCol->Name = L"loadCol";
			this->loadCol->Width = 40;
			// 
			// filesCol
			// 
			...
			this->ClientSize = System::Drawing::Size(1181, 495);
...
#pragma endregion
	private: System::Void dataGridView3_CellContentClick(System::Object^ sender, System::Windows::Forms::DataGridViewCellEventArgs^ e) {
		...
		if (e->ColumnIndex == 0)
			loadFile(this->dataGridView3->Rows[e->RowIndex]->Cells[1]->Value->ToString());
	}
